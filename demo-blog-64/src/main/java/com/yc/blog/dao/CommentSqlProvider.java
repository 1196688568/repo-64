...
import com.yc.blog.bean.CommentExample.Criteria;
import com.yc.blog.bean.CommentExample.Criterion;
...
public class CommentSqlProvider {
    ...
    public String insertSelective(Comment record) {
        ...
        if (record.getCreateby() != null) {
            sql.VALUES("createBy", "#{createby,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getCreateby() != null) {
            sql.SET("createBy = #{record.createby,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(Comment record) {
        ...
        if (record.getCreateby() != null) {
            sql.SET("createBy = #{createby,jdbcType=INTEGER}");
        }
