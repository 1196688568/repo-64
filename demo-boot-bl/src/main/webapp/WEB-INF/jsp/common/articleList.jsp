...
<c:forEach items="${aList}" var="a">
	<article class="excerpt excerpt-1">
		<a class="focus" href="article?id=${a.id}" title=""><img class="thumb" data-original="images/excerpt.jpg" src="images/excerpt.jpg" alt=""></a>
		<header>
			<a class="cat" href="category?id=${a.category.id}">${a.category.name}<i></i></a>
		...
		<p class="meta">
			...
			<a class="comment" href="${a.id}#comment">
